...
VERILOG_SOURCES += $(RTL_DIR)/registers.v $(RTL_DIR)/cpu.v $(RTL_DIR)/alu.v $(RTL_DIR)/ice_mem.v $(RTL_DIR)/inst_mem.v $(RTL_DIR)/mips_control.v $(RTL_DIR)/ice_top.v $(RTL_DIR)/clock_div.v
